...
This repo also contains pre-made league files (.dat/.dir, opening either of them in the interface will work) for some competitions that users may want to play the game with. There are files for the 2026 season of the Super League competition as well as the 2026, 2027 and 2028 seasons of the NRL based on the expected entry of Perth Bears into the competition in 2027 followed by Papua New Guinea Chiefs in 2028.
